...
#endif // QT_CONFIG(statustip)
        self.action_save_py.setText(QCoreApplication.translate("MainWindow", u"Save interactive plot *.py (Beta)", None))
#if QT_CONFIG(tooltip)
        self.action_save_py.setToolTip(QCoreApplication.translate("MainWindow", u"Save interactive plot *.py (Beta)", None))
        self.action_save_py.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+E", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
